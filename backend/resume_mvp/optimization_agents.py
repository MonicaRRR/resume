...
def _writer_prompt(
    ...
    return _prompt(
        ...
        constraints=[
            ...
            "工作/项目经历必须按 STAR 组织：说明情境或任务、个人行动、结果；不能只有职责罗列。",
            "能分点就分点，优先拆成 2–4 条有信息量的 bullets；每条尽量填满一行主要宽度，避免只有几个字的孤行或短尾行。",
...
def _reviewer_prompt(
    ...
    return _prompt(
        ...
        constraints=[
            ...
            "检查中文表达是否简洁、具体且无重复",
            "检查工作/项目是否遵循 STAR、是否能分点表达，以及 bullet 是否过短导致版面稀疏；发现问题时必须写入 refinement_instructions",
